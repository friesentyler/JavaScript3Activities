...
const App = () => {
	const [albumList, setAlbumList] = useState([
		...
		},
		{
			...
			year: 1969,
			image:
				'https://upload.wikimedia.org/wikipedia/en/thumb/4/42/Beatles_-_Abbey_Road.jpg/230px-Beatles_-_Abbey_Road.jpg',
		},
		{
			artistId: 2,
			artist: 'The Beatles',
	...
	return <div className='container'>{renderAlbumList()}</div>;
};
