import { deleteAlbum, readAlbumsByAlbumId, readAlbumsByArtist, readAlbumsByArtistSearch, readAlbumsByDescriptionSearch, updateAlbum } from "./album.dao";
...
export const albumQueries = {
	...
	readAlbumsByArtist: `SELECT id as albumId, title as title, artist AS artist, description AS description, year AS year, image AS image FROM music.albums WHERE music.albums.artist LIKE ?`,
	readAlbumsByArtistSearch: `SELECT id AS albumId, title AS title, artist AS artist, description AS description, year AS year, image AS image FROM music.albums WHERE music.albums.description LIKE ?`,
